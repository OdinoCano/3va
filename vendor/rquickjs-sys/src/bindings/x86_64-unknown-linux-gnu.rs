...
extern "C" {
    pub fn JS_SetCurrentAsyncCtxId(rt: *mut JSRuntime, id: u64);
}
extern "C" {
    pub fn JS_GetCurrentAsyncCtxId(rt: *mut JSRuntime) -> u64;
}
pub type JSJobBeforeExecuteHook = ::std::option::Option<
    unsafe extern "C" fn(async_ctx_id: u64, opaque: *mut ::std::os::raw::c_void),
>;
extern "C" {
    pub fn JS_SetJobBeforeExecuteHook(
        rt: *mut JSRuntime,
        hook: JSJobBeforeExecuteHook,
        opaque: *mut ::std::os::raw::c_void,
    );
}

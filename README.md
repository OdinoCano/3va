...
| HTTP throughput (100k req, c=1000) | <!--BENCH:http-node-->36,054 req/s<!--/BENCH:http-node--> | **<!--BENCH:http-bun-->88,385 req/s<!--/BENCH:http-bun-->** | <!--BENCH:http-3va-->39,810 req/s<!--/BENCH:http-3va-->³ |
| Memory, idle → under load | <!--BENCH:mem-node-->50.1 → 88.1 MB<!--/BENCH:mem-node--> | **<!--BENCH:mem-bun-->19.4 → 38.0 MB<!--/BENCH:mem-bun-->** | <!--BENCH:mem-3va-->49.1 → 205.0 MB<!--/BENCH:mem-3va--> |
| Install time (warm cache)⁶ | <!--BENCH:install-npm-->338.0 ms<!--/BENCH:install-npm--> | <!--BENCH:install-bun-->2.0 ms<!--/BENCH:install-bun--> | <!--BENCH:install-3va-->23.1 ms<!--/BENCH:install-3va--> |

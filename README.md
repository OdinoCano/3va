...
| HTTP throughput (100k req, c=1000) | <!--BENCH:http-node-->19,056 req/s<!--/BENCH:http-node--> | **<!--BENCH:http-bun-->54,112 req/s<!--/BENCH:http-bun-->** | <!--BENCH:http-3va-->6,899 req/s<!--/BENCH:http-3va-->³ |
| Memory, idle → under load | <!--BENCH:mem-node-->48.0 → 77.2 MB<!--/BENCH:mem-node--> | **<!--BENCH:mem-bun-->41.8 → 50.7 MB<!--/BENCH:mem-bun-->** | <!--BENCH:mem-3va-->50.8 → 87.0 MB<!--/BENCH:mem-3va--> |
| Install time (warm cache)⁶ | <!--BENCH:install-npm-->1026.1 ms<!--/BENCH:install-npm--> | <!--BENCH:install-bun-->3.7 ms<!--/BENCH:install-bun--> | <!--BENCH:install-3va-->23.7 ms<!--/BENCH:install-3va--> |

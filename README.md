...
| Install time (warm cache) | — | — | 24.8 ms |
...
For install-time performance, see the [Comparison](#comparison) table above (24.8 ms warm-cache install, CI-measured) — that number is authoritative; treat any other install-timing figure you find elsewhere (older commits, issues, etc.) as stale.

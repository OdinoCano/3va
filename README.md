...
| ECMAScript (test262) conformance⁷ | ~100%, self-reported (is V8) | ~99.9%, self-reported (JavaScriptCore) | <!--BENCH:test262-3va-->96.9% (95457/98556, 0 skipped)<!--/BENCH:test262-3va--> |
...
| HTTP throughput (100k req, c=1000) | <!--BENCH:http-node-->18,344 req/s<!--/BENCH:http-node--> | **<!--BENCH:http-bun-->84,750 req/s<!--/BENCH:http-bun-->** | <!--BENCH:http-3va-->27,756 req/s<!--/BENCH:http-3va-->³ |
| Memory, idle → under load | <!--BENCH:mem-node-->48.9 → 85.5 MB<!--/BENCH:mem-node--> | **<!--BENCH:mem-bun-->19.5 → 38.3 MB<!--/BENCH:mem-bun-->** | <!--BENCH:mem-3va-->51.2 → 121.0 MB<!--/BENCH:mem-3va--> |
| Install time (warm cache)⁶ | <!--BENCH:install-npm-->421.0 ms<!--/BENCH:install-npm--> | <!--BENCH:install-bun-->2.4 ms<!--/BENCH:install-bun--> | <!--BENCH:install-3va-->23.1 ms<!--/BENCH:install-3va--> |

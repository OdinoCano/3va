...
| HTTP throughput (100k req, c=1000) | 19,056 req/s | **54,112 req/s** | 6,899 req/s³ |
| Memory, idle → under load | 48.0 → 77.2 MB | **41.8 → 50.7 MB** | 50.8 → 87.0 MB |
| Install time (warm cache)⁶ | <!--BENCH:install-npm-->not yet in CI<!--/BENCH:install-npm--> | <!--BENCH:install-bun-->not yet in CI<!--/BENCH:install-bun--> | <!--BENCH:install-3va-->not yet in CI<!--/BENCH:install-3va--> |

...
| Feature | Node.js 24 | Bun 1.3 | **3va 2.8.0** |
|---|---|---|---|
| JavaScript runtime | ✓ | ✓ | ✓ |
...
| License | MIT | MIT | MIT |
| First release → latest | 2009 → 24.x | 2023 → 1.3 | [v1.0.0](https://github.com/OdinoCano/3va/releases/tag/v1.0.0) → [v2.8.0](https://github.com/OdinoCano/3va/releases/tag/v2.8.0) |

...
| Feature | Node.js 24 | Bun 1.3 | **3va 2.8.2** |
|---|---|---|---|
| JavaScript runtime | ✓ | ✓ | ✓ |
...
| ECMAScript (test262) conformance⁷ | ~100%, self-reported (is V8) | ~99.9%, self-reported (JavaScriptCore) | <!--BENCH:test262-3va-->96.9% (95459/98558, 0 skipped)<!--/BENCH:test262-3va--> |
| Platforms | Linux/macOS/Windows/Android | Linux/macOS/Windows | Linux/macOS/Windows⁵ |
| License | MIT | MIT | MIT |
| First release → latest | 2009 → 24.x | 2023 → 1.3 | [v1.0.0](https://github.com/OdinoCano/3va/releases/tag/v1.0.0) → [v2.8.2](https://github.com/OdinoCano/3va/releases/tag/v2.8.2) |
| Startup time (hello world) | 28.2 ms | **15.4 ms** | 25.8 ms |
| HTTP throughput (100k req, c=1000) | <!--BENCH:http-node-->21,520 req/s<!--/BENCH:http-node--> | **<!--BENCH:http-bun-->81,093 req/s<!--/BENCH:http-bun-->** | <!--BENCH:http-3va-->28,483 req/s<!--/BENCH:http-3va-->³ |
| Memory, idle → under load | <!--BENCH:mem-node-->50.0 → 88.5 MB<!--/BENCH:mem-node--> | **<!--BENCH:mem-bun-->19.5 → 37.8 MB<!--/BENCH:mem-bun-->** | <!--BENCH:mem-3va-->50.9 → 115.2 MB<!--/BENCH:mem-3va--> |
| Install time (warm cache)⁶ | <!--BENCH:install-npm-->407.5 ms<!--/BENCH:install-npm--> | <!--BENCH:install-bun-->2.3 ms<!--/BENCH:install-bun--> | <!--BENCH:install-3va-->23.1 ms<!--/BENCH:install-3va--> |

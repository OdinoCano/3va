...
| ECMAScript (test262) conformance⁷ | ~100%, self-reported (is V8) | ~99.9%, self-reported (JavaScriptCore) | <!--BENCH:test262-3va-->96.9% (95441/98532, 0 skipped)<!--/BENCH:test262-3va--> |
...
| HTTP throughput (100k req, c=1000) | <!--BENCH:http-node-->23,267 req/s<!--/BENCH:http-node--> | **<!--BENCH:http-bun-->84,662 req/s<!--/BENCH:http-bun-->** | <!--BENCH:http-3va-->33,379 req/s<!--/BENCH:http-3va-->³ |
| Memory, idle → under load | <!--BENCH:mem-node-->48.9 → 86.4 MB<!--/BENCH:mem-node--> | **<!--BENCH:mem-bun-->19.9 → 38.2 MB<!--/BENCH:mem-bun-->** | <!--BENCH:mem-3va-->51.0 → 200.9 MB<!--/BENCH:mem-3va--> |
| Install time (warm cache)⁶ | <!--BENCH:install-npm-->350.8 ms<!--/BENCH:install-npm--> | <!--BENCH:install-bun-->2.3 ms<!--/BENCH:install-bun--> | <!--BENCH:install-3va-->23.1 ms<!--/BENCH:install-3va--> |

class ThreeVa < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/OdinoCano/3va/releases/download/v2.5.0/3va-v2.5.0-x86_64-apple-darwin.tar.gz"
      sha256 "1cbd8c7ac15212ec0823feed8efbe9d69d0fd0ccab5968373ce88365fe07d68b"
    end
    on_arm do
      url "https://github.com/OdinoCano/3va/releases/download/v2.5.0/3va-v2.5.0-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/OdinoCano/3va/releases/download/v2.5.0/3va-v2.5.0-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "40ec5c8f5be775600ad5a593d9af569eb8d0a2a84c79a45f59fddc72d57bfdbb"
    end
    on_arm do
      url "https://github.com/OdinoCano/3va/releases/download/v2.5.0/3va-v2.5.0-aarch64-unknown-linux-gnu.tar.gz"

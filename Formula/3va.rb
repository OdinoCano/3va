class ThreeVa < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/OdinoCano/3va/releases/download/vv2.1.3/3va-vv2.1.3-x86_64-apple-darwin.tar.gz"
      sha256 "41c1fae6ce7a4dcd51ab0bf35a4b8ad9d26d71d2a7b197c06b21e1ea872c399d"
    end
    on_arm do
      url "https://github.com/OdinoCano/3va/releases/download/vv2.1.3/3va-vv2.1.3-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/OdinoCano/3va/releases/download/vv2.1.3/3va-vv2.1.3-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "199219ca9aaaa20eff117c294e68ceb21147a2e4ae84e6bc36bcc8f111824ce3"
    end
    on_arm do
      url "https://github.com/OdinoCano/3va/releases/download/vv2.1.3/3va-vv2.1.3-aarch64-unknown-linux-gnu.tar.gz"

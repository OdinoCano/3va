class ThreeVa < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/OdinoCano/3va/releases/download/v2.8.2/3va-v2.8.2-x86_64-apple-darwin.tar.gz"
      sha256 "091f75dc1ab013322ba1fde60f6218996f112b66237ed72fdd125f480963a159"
    end
    on_arm do
      url "https://github.com/OdinoCano/3va/releases/download/v2.8.2/3va-v2.8.2-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/OdinoCano/3va/releases/download/v2.8.2/3va-v2.8.2-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "50e547eb63deef39e3748e8112d893e73e9398b6dda83b452126639fd5dc9cb4"
    end
    on_arm do
      url "https://github.com/OdinoCano/3va/releases/download/v2.8.2/3va-v2.8.2-aarch64-unknown-linux-gnu.tar.gz"

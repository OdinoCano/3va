        ...
        AuditReport {
            findings: vec![VulnFinding {
                ...
                vulns: vec![Vulnerability {
                    id: "GHSA-2c7v-hp11-w3gz".to_string(),
                    severity: VulnSeverity::Critical,
                    summary: "Remote code execution".to_string(),
                    fixed_versions: vec!["1.0.1".to_string()],
                    details_url: "https://osv.dev/GHSA-2c7v-hp11-w3gz".to_string(),
                }],
            }],
            total_packages: 1,
            packages_with_vulns: 1,
    ...
    fn report_with_high_only() -> AuditReport {
        AuditReport {
            findings: vec![VulnFinding {
                ...
                vulns: vec![Vulnerability {
                    id: "GHSA-qcql-w8v5-99xc".to_string(),
                    severity: VulnSeverity::High,
                    summary: "SQL injection".to_string(),
                    fixed_versions: vec![],
                    details_url: "https://osv.dev/GHSA-qcql-w8v5-99xc".to_string(),
                }],
            }],
            total_packages: 2,
            packages_with_vulns: 1,
